...
CREATE TABLE players (
    ...
    ab1_dhigh INTEGER(3) NOT NULL DEFAULT 10,
    ab1_speed INTEGER(1) NOT NULL DEFAULT 5,
    ab1_strm DECIMAL(3,2) NOT NULL DEFAULT 0.00,
    ab1_crit DECIMAL(3,2) NOT NULL DEFAULT 0.00,
    ab1_fail DECIMAL(3,2) NOT NULL DEFAULT 0.00,

    ab2_name VARCHAR(30) NOT NULL DEFAULT "Kick",
    ab2_dlow INTEGER(3) NOT NULL DEFAULT 8,
    ab2_dhigh INTEGER(3) NOT NULL DEFAULT 15,
    ...
    ab3_dhigh INTEGER(3) NOT NULL DEFAULT 25,
