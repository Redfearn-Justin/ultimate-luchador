...
const FightText = props => (
  <p>Woah!
    ...
    ({props.crit}{props.fail}<span style={{ color: props.ab_color }}>{props.dmg} dmg</span>: <span style={{ color: props.results_color }}>{props.who} have {props.hp_left} hp remaining</span>)</p>
);
