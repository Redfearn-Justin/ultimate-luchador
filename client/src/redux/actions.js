export const setPageName = (pageName, id, char_name) => ({type: 'SET_PAGE_NAME', pageName, id, char_name});
export const loginToken = (pageName, token) => ({type: 'LOGIN_TOKEN', pageName, token});
export const incrementWins = () => ({type: 'INCREMENT_WINS'});

export const getAllData = (id, char_name) => ({type: 'GET_ALL_DATA', id, char_name});
